...
# load map and create a collision mask
...
def race():
    ...
    def eval_genomes(genomes, config):
        nonlocal display_map, collision_mask, screen
        nonlocal manual_car, manual_angular_velocity, start_pos, metadata
        nonlocal manual_finished, best_car_finished
        nonlocal map_path, show_modes_dropdown
        ...
        while running:
            ...
            # handle buttons and dropdown menu
            ...
            leaderboard = []
            if best_car:
                label = "AI Car (Finished)" if best_car_finished else "AI Car"
                leaderboard.append((label, best_car.distance))
